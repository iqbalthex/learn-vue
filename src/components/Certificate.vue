...
<template>
  <section id="certificates" class="flex flex-col min-h-screen p-4 items-center bg-gray-200 lg:px-8 dark:bg-gray-800">
    <h2 class="text-4xl font-bold">Certificates</h2>
    <h3 class="text-xl">These are certified knowledge I have</h3>
    <ul class="w-full flex flex-col gap-4 mt-4">
      <li v-for="certificate, index in certificates"
        ...
        <div :class="{ 'md:order-2': index % 2 === 0 }"
          class="certificate-wrapper relative p-1 overflow-hidden rounded-xl md:w-[500px]" :data-wrapper="index">
