...
<header class="w-full px-4 py-3 justify-stretch bg-violet-400 sticky top-0 lg:flex lg:pr-6 lg:justify-end dark:bg-gray-800" style="z-index: 100">
  ...
  <nav :class="[ navbarHidden ? 'h-0 lg:h-full' : 'h-full' ]"
